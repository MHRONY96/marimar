	...
	<div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo WEB_ROOT; ?>index.php">Marimar</a>
			</div>
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="<?php echo (currentpage() == 'mod_accomodation') ? "active" : false;
											?>"><a href="<?php echo WEB_ROOT;
																		?>#admin/mod_accomodation/index.php">Accomodation</a></li>
					...
					<li class="<?php echo (currentpage() == 'mod_reservation') ? "active" : false;
						...
						?>
						<a href="<?php // echo WEB_ROOT; 
											?>#admin/mod_reservation/index.php">Reservation <?php //echo  isset($result->Total) ? '<span style="color:red">(' . $result->Total . ')</span>' : ''; 
																																			?> </a>
						<?php
						//}
						?>
					...
					<li class="<?php // echo (currentpage() == 'mod_reports') ? "active" : false; 
											?>"><a href="<?php //echo WEB_ROOT; 
																		?>#admin/mod_reports/index.php">Reports</a></li>
